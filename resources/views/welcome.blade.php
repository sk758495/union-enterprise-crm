...
<head>
  ...
  @include('User-Management.head')

</head>

<body class="index-page">

  @include('User-Management.navbar')
          ...
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="300">
            <div class="hero-visual">
              <div class="hero-image-wrapper">
                <img src="{{ asset('user/assets/img/illustration/illustration-15.webp') }}" class="img-fluid hero-image" alt="Hero Image">
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="300">
            <div class="visual-section">
              <div class="main-image-container">
                <img src="{{ asset('user/assets/img/about/about-8.webp') }}" alt="Professional team collaboration" class="img-fluid main-visual">
              ...
              <div class="secondary-images">
                <div class="row g-3">
                  <div class="col-6">
                    <img src="{{ asset('user/assets/img/about/about-11.webp') }}" alt="Team meeting" class="img-fluid secondary-img">
                  </div>
                  <div class="col-6">
                    <img src="{{ asset('user/assets/img/about/about-5.webp') }}" alt="Office workspace" class="img-fluid secondary-img">
                  </div>
                </div>
              </div>
            </div>
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('user/assets/img/features/features-4.webp') }}" alt="" class="img-fluid">
            ...
            <div class="tab-pane fade" id="features-tab-2">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('user/assets/img/features/features-2.webp') }}" alt="" class="img-fluid">
                      <div class="floating-card">
                        <i class="bi bi-shield-check"></i>
                        <div class="card-content">
                          <span>Security</span>
            ...
            <div class="tab-pane fade" id="features-tab-3">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('user/assets/img/features/features-6.webp') }}" alt="" class="img-fluid">
                      <div class="floating-card">
            ...
            <div class="tab-pane fade" id="features-tab-4">
              <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                  <div class="visual-content">
                    <div class="main-image">
                      <img src="{{ asset('user/assets/img/features/features-1.webp') }}" alt="" class="img-fluid">
                      <div class="floating-card">
                        <i class="bi bi-headset"></i>
                        <div class="card-content">
                          <span>Support</span>
        ...
        <div class="row g-4">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="150">
            <div class="feature-card">
              ...
              <div class="feature-image">
                <img src="{{ asset('user/assets/img/features/features-1.webp') }}" alt="Dashboard Interface" class="img-fluid" loading="lazy">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-card highlighted">
              ...
              <div class="feature-image">
                <img src="{{ asset('user/assets/img/features/features-2.webp') }}" alt="Analytics Tools" class="img-fluid" loading="lazy">
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="250">
            <div class="feature-card">
              ...
              <div class="feature-image">
                <img src="{{ asset('user/assets/img/features/features-3.webp') }}" alt="Security Features" class="img-fluid" loading="lazy">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="row align-items-center">
            <div class="col-lg-6" data-aos="zoom-in">
              <div class="testimonial-image">
                <img src="{{ asset('user/assets/img/features/features-4.webp') }}" alt="Testimonial" class="img-fluid">
              </div>
            </div>
        ...
        <div class="row align-items-lg-center">
          <div class="col-lg-5 order-lg-2" data-aos="fade-left" data-aos-delay="200">
            <div class="image-wrapper position-relative">
              ...
              <img src="{{ asset('user/assets/img/misc/misc-6.webp') }}" alt="Security Solutions" class="img-fluid main-image">
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="swiper init-swiper">
          ...
          <div class="swiper-wrapper align-items-center">
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-1.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-2.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-3.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-4.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-5.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-6.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-7.webp') }}" class="img-fluid" alt=""></div>
            <div class="swiper-slide"><img src="{{ asset('user/assets/img/clients/clients-8.webp') }}" class="img-fluid" alt=""></div>
          </div>
        </div>
        ...
        <div class="testimonial-masonry">
            ...
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('user/assets/img/person/person-f-7.webp') }}" alt="Client">
                </div>
          ...
          <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="100">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('user/assets/img/person/person-m-7.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Daniel Morgan</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="200">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('user/assets/img/person/person-f-8.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Emma Thompson</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="300">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('user/assets/img/person/person-m-8.webp') }}" alt="Client">
                </div>
                <div class="client-details">
          ...
          <div class="testimonial-item highlight" data-aos="fade-up" data-aos-delay="400">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('user/assets/img/person/person-f-9.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Olivia Carter</h3>
          ...
          <div class="testimonial-item" data-aos="fade-up" data-aos-delay="500">
            <div class="testimonial-content">
              ...
              <div class="client-info">
                <div class="client-image">
                  <img src="{{ asset('user/assets/img/person/person-m-13.webp') }}" alt="Client">
                </div>
                <div class="client-details">
                  <h3>Nathan Brooks</h3>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
            <div class="hero-visual" data-aos="fade-left" data-aos-delay="150">
              <img src="{{ asset('user/assets/img/services/services-1.webp') }}" alt="Services" class="img-fluid">
            </div>
          </div>
        </div>
  ...
  <!-- Footer Section -->
  @include('User-Management.footer')
